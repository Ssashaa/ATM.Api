...
namespace ATM.Api.Controllers
{
    ...
    public class CardController : Controller
    {
        ...
        {
            if (Data.Cards.Any(x => x.CardNumber == cardNumber))
            {
        ...
        {
            if (Data.Cards.Any(x => x.CardNumber == cardNumber && x.Password == password))
            {
                return Ok("Your card is in the system!");
            }
        ...
        {
            var balance = Data.Cards.Where(x => x.CardNumber == cardNumber).Select(x => x.Balance);
            return Ok(balance);
        }
        ...
        {
            var balance = Data.Cards.Where(x => x.CardNumber == cardNumber).First();
